> Initial fork of Ares Deveaux's addon 
## TODO
- [ ] Fix AnimOffset Mask
- [ ] Support for stepped playblast and playblast tools
- [ ] More tools for frame interpolation and camera helpers
- [ ] Preview options for frames between markers
- [ ] More tools for stop motion animators
- [ ] Animation Layers (Haha a bit ambitious)
- [ ] Removal of  
